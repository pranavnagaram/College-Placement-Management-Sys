...
// recruiter
const LoginRecruiter = lazy(() => import("./pages/Recruiter/Login.jsx"));
const RegisterRecruiter = lazy(() => import("./pages/Recruiter/Register.jsx"));
const HomeRecruiter = lazy(() => import("./pages/Recruiter/Home.jsx"));
const MyCompanyRecruiter = lazy(() => import("./components/Recruiter/MyCompany.jsx"));
const PostJobRecruiter = lazy(() => import("./components/Recruiter/PostJob.jsx"));
      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['recruiter']} /></UserProvider>}>
              {/* recruiter dashboard */}
              <Route element={<Layout header="Dashboard" />}>
                <Route path="/recruiter/dashboard" element={<HomeRecruiter />} />
              </Route>
              {/* account */}
              <Route element={<Layout header="Account Details" />}>
                <Route path="/recruiter/account" element={<Account />} />
              </Route>
              {/* my company */}
              <Route element={<Layout header="My Company" />}>
                <Route path="/recruiter/my-company" element={<MyCompanyRecruiter />} />
              </Route>
              {/* all job listings */}
              <Route element={<Layout header="Job Listings" />}>
                <Route path="/recruiter/job-listings" element={<AllJobPost />} />
              </Route>
              {/* post new job */}
              <Route element={<Layout header="Post New Job" />}>
                <Route path="/recruiter/post-job" element={<PostJobRecruiter />} />
              </Route>
              {/* edit job */}
              <Route element={<Layout header="Edit Job" />}>
                <Route path="/recruiter/post-job/:jobId" element={<PostJobRecruiter />} />
              </Route>
              {/* view a job post */}
              <Route element={<Layout header="Job Listing" />}>
                <Route path="/recruiter/job/:jobId" element={<ViewJobPost />} />
              </Route>
            </Route>
          </Routes>
        </Suspense>
