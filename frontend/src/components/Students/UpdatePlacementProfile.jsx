                ...
                <div className="grid grid-cols-2 gap-4 my-4 text-base max-sm:text-sm">
                  ...
                  <div className="col-span-2 backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6">
                    ...
                    <div className="grid grid-cols-2 max-sm:grid-cols-1">
                      ...
                      <div className="px-2 py-3 flex flex-col gap-2">
                        <FloatingLabel controlId="floatingSelectHSC" label="Class 12 Board Name">
                          <Form.Select
                            aria-label="Floating label select Class 12 Board"
                            className='cursor-pointer'
                            name='hscBoard'
                          ...
                          >
                            <option disabled value="undefined" className='text-gray-400'>Enter Your Class 12 Board Name</option>
                            <option value="Jharkhand Academic Council">Jharkhand Academic Council</option>
                            <option value="Central Board of Secondary Education (CBSE)">Central Board of Secondary Education (CBSE)</option>
                            <option value="Council for the Indian School Certificate Examinations (CISCE)">Council for the Indian School Certificate Examinations (CISCE)</option>
                            <option value="NoHSC">No Class 12</option>
                            <option value="Other">Other</option>
                          </Form.Select>
                        </FloatingLabel>
                        <FloatingLabel controlId="floatingHSCMarks" label="Class 12 Percentage">
                          <Form.Control
                            type="number"
                        ...
                        <FloatingLabel controlId="floatingSelectHSCPassingYear" label="Class 12 Passing Year">
                          <Form.Control
                            type="number"
