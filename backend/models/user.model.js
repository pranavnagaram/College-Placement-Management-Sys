...
const UserSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ['student', 'tpo_admin', 'management_admin', 'superuser', 'recruiter'], required: true },
  profile: {
    type: String,
    ...
    appliedJobs: [
      {
        ...
        status: { type: String, enum: ['applied', 'interview', 'hired', 'rejected', 'offer_accepted', 'offer_declined'], default: 'applied' },
        package: { type: Number },
